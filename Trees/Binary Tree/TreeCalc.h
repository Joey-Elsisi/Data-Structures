...
public:
    ...
    void printInfix(TreeNode * curNode, bool isRightDigit) const;	//prints data in infix form
    ...
    int doTheMath(TreeNode * curNode, int left, int right) const;
    bool isOperator(string val) const;
